export function Datenschutz() {
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-10 text-ink-700">
      <h1 className="text-4xl font-semibold text-ink-900">Datenschutzerklärung</h1>
      ...
      <section>
        <h2 className="mb-1 text-xl font-semibold text-ink-900">Hosting & Datenhaltung</h2>
        <p className="text-sm">
      ...
      <section>
        <h2 className="mb-1 text-xl font-semibold text-ink-900">Newsletter</h2>
        <p className="text-sm">
      ...
      <section>
        <h2 className="mb-1 text-xl font-semibold text-ink-900">Konto & Login</h2>
        <p className="text-sm">
      ...
      <section>
        <h2 className="mb-1 text-xl font-semibold text-ink-900">Kein Tracking</h2>
        <p className="text-sm">
